...
% 
% %embedding_dimensions_all_sessions(session,Area,threshold,Ndir,Nbins,do_plot,t_from,t_upto,mov_durS,session_N,plot_supp);
% embedding_dimensions_all_sessions(session,Area,threshold,Ndir,Nbins,t_from,t_upto,mov_durS,session_N,plot_traj_all_rec,plot_supp);

% %% Figure 3
tic
do_plot_supp=0;
recurrence_all_sessions(session,Area,threshold,Ndir,Nbins,threshold_dist,do_plot_supp)
toc
