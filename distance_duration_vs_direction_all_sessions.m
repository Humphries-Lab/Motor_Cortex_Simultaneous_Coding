...
disp(['Min p-value delta control =', num2str(min(p_delta_distance_same))])
disp(['Average p-value delta control =', num2str(mean(p_delta_distance_same))])

text(1,-0.001,['max p-value = ' num2str(min(p_delta_distance_same),'%.e')])

text(1,0.01,['mean p-value = ' num2str(mean(p_delta_distance_same),'%.e')])
